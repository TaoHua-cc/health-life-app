...
(function () {
  ...
  function paintTrend(section, values) {
    ...
    var tip=q('.trend-tip',section),hotValues=values.filter(function(v){return v>=goal();});
    if(tip){if(hotValues.length){tip.textContent=Math.round(Math.max.apply(Math,hotValues));tip.style.display='';}else tip.style.display='none';}
  ...
  function refreshHome() {
    ...
    var mood=(dayData().life||{}).mood||'\ud83d\ude42',foot=qa('.rb-home-status-item',root);
    if(foot[0]){foot[0].setAttribute('onclick','xmOpenMoodPicker()');foot[0].style.cursor='pointer';}
    if(!records) return;
    ...
    var moodLabel={'\ud83d\ude04':'开心','\ud83d\ude42':'平静','\ud83d\ude0a':'充实','\ud83d\ude14':'疲惫','\ud83d\ude23':'难过'}[mood]||'开心';
    if(foot[0]){var moodIcon=q('.status-foot-icon',foot[0]);if(moodIcon)moodIcon.src='assets/xiaoman-v3/status-mood-v2.png';var moodText=q('b',foot[0]),moodSub=q('small',foot[0]);if(moodText)moodText.textContent=moodLabel;if(moodSub)moodSub.textContent='今日心情';foot[0].setAttribute('onclick','xmOpenMoodPicker()');foot[0].style.cursor='pointer';}
  ...
  function homeStyle(){if(q('#xm-home-style'))return;var s=document.createElement('style');s.id='xm-home-style';s.textContent='.rb-home-pixel-head{height:123px!important}.rb-home-pixel-status{height:249px!important;min-height:249px!important;padding:42px 10px 9px!important}.rb-home-pixel-status-grid{grid-template-columns:145px minmax(0,1fr)!important;gap:8px!important;align-items:center!important}.rb-home-pixel-ring{width:145px!important;height:145px!important}.rb-home-pixel-ring b{font-size:36px!important}.rb-home-pixel-macros{gap:8px!important}.rb-home-pixel-macros>div{min-height:38px!important;padding-bottom:5px!important}.rb-home-pixel-meals{height:134px!important;margin-top:17px!important}.rb-home-pixel-trend{height:171px!important;margin-top:17px!important}.rb-home-pixel-status-foot .rb-home-status-item{display:flex;align-items:center;justify-content:center;gap:4px}.rb-home-pixel-status-foot .rb-home-status-item>i{width:24px;height:24px;display:grid;place-items:center;font-style:normal}.rb-home-pixel-status-foot .status-foot-icon{width:22px;height:22px;object-fit:contain}.rb-home-pixel-status-foot .rb-home-status-item b{font-size:12px}.rb-home-pixel-status-foot .rb-home-status-item small{display:block;font-size:9px;font-weight:600;color:#7b624d}.rb-home-pixel-status-foot .rb-home-status-item>div{line-height:1.15}.rb-home-pixel-status-foot{grid-template-columns:1.1fr 1fr 1fr!important}body.rb-home-page .rb-nav button.on{background:transparent!important;color:#789438!important}';document.head.appendChild(s);}
